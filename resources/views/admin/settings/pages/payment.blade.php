...
<div class="card">
    <div class="card-body" x-init>
        ...
        <h2 class="flex items-center justify-center mb-8 space-x-4 text-2xl font-bold text-center text-gray-700">
            ...
            <span>Payment Page Settings</span>
        </h2>
        <form action="{{route('admin.settings.pages.payment.update')}}" method="post">
            @csrf
            @if (session('success'))
            ...
            <div class="flex items-center mt-4 space-x-4">
                ...
                <div class="w-[90%] h-80">
                    <textarea id="ckPageContent"
                        class="px-4 py-2 bg-gray-100 h-84 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 normal-case"
                        name="payment">{{$payment}}</textarea>
                </div>
            </div>
