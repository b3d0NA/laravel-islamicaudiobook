...
<div x-data="{isOpen: false}"
    ...
    <div @nav-trigger.window="$el.classList.contains('md:hidden') ? $el.classList.remove('md:hidden') : $el.classList.add('md:hidden')"
        ...
        <div class="flex flex-row-reverse items-center">
            ...
            <!-- user -->
            <div class="relative dropdown md:static" x-cloak>

                <button @click="isOpen = !isOpen"
                    class="flex flex-wrap items-center menu-btn focus:outline-none focus:shadow-outline">
                    <div class="w-8 h-8 overflow-hidden rounded-full">
                        <svg class="object-cover w-full h-full" data-name="Layer 1" viewBox="0 0 676 676">
                            ...
                            <path
                                ...
                                transform="translate(-262 -112)" fill="#718096" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-262 -112)" fill="#2f2e41" />
                            <path d="M856.67,576.32l52.99,9.36A337.94434,337.94434,0,0,1,852.9,674.25Z"
                                transform="translate(-262 -112)" fill="#2f2e41" />
                        </svg>
                    </div>
                ...
                <button @click="isOpen = !isOpen"
                    class="fixed top-0 left-0 z-10 hidden w-full h-full menu-overflow"></button>
