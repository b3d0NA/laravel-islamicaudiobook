<div wire:ignore.self x-cloak x-data="{isOpen:false}" x-show="isOpen" x-transition.opacity
    ...
    window.Livewire.on('prepareRequestDelete', () => isOpen=true)
    window.Livewire.on('BookRequestDeletedSuccessfully', () => isOpen=false)
    ">
            ...
            <div class="bg-white sm:px-4 sm:pt-5 sm:pb-4 p-6 pb-4">
                ...
                <div class="bg-gray-50 sm:px-4 py-3 px-6 sm:block flex flex-row-reverse">
                    <button wire:click.prevent="delete"
                        ...
                        <svg wire:loading wire:target="delete" class="animate-spin h-5 w-5 text-white"
