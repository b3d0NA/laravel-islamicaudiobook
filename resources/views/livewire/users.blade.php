<div class="card-body" x-init>
    ...
    <table class="table-auto w-full border rounded-xl">
        ...
        <tbody class="text-left text-gray-600">
            ...
            <tr @class(["bg-teal-50"=> $loop->even])>
                ...
                <td wire:ignore.self
                    ...
                    <button wire:click.prevent="delete({{$user->id}})" href="#" class="btn-bs-danger">
                        <svg wire:loading wire:target="delete({{$user->id}})" class="animate-spin h-5 w-5 text-white"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4">
                            </circle>
                            <path class="opacity-75" fill="currentColor"
            ...
            @empty
            <tr>
                <td colspan='9' class="text-center text-orange-500 text-xl py-3">In Shaa Allaah! User will be registered
                    soon. Be
                    patient.
                </td>
            </tr>
