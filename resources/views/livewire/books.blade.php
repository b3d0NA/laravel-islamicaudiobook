                ...
                <div wire:loading.remove
                    ...
                    <div class="rounded-tr-2xl rounded-br-2xl min-h-[300px] w-[230px] overflow-hidden book-image">
                        ...
                        <div class="book-image-overflow">
                            <h2
                                class="p-1 px-4 text-white rounded-lg text-md bg-gradient-to-r from-amber-300 to-amber-500">
                                Publication:
                                {{ $book->publication }}
                            </h2>
                            ...
                            @auth
                                <h2
                                    class="p-1 px-4 text-white rounded-lg text-md bg-gradient-to-r from-teal-300 to-teal-500">
                                    Total Reads:
                                ...
                                @else
                                    <p class="px-2 py-3 my-3 text-xs italic font-light normal-case">
                                        ...
                                        <a href="{{ route('user.survey.index') }}"
                                            class="text-blue-500 hover:underline">survey form</a>
                                ...
                                @else
                                    <p class="px-2 py-3 my-3 text-xs italic font-light normal-case">
                                        ...
                                        <a href="{{ route('user.payment.index') }}"
                                            class="text-blue-500 hover:underline">making payment</a>
                                        to read this book.
                                    </p>
                                @endif
                            @endif
