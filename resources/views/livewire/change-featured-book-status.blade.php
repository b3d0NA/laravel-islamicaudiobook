<div wire:ignore.self x-cloak x-data="{isOpen:false}" x-show="isOpen" x-transition.opacity
    ...
    window.Livewire.on('prepareBookStatusChange', () => isOpen=true)
    window.Livewire.on('BookStatusChangedSuccessfully', () => isOpen=false)
    ">
                    ...
                    <div class="sm:mt-3 sm:text-center sm:ml-0 mt-0 ml-4 text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 normal-case">
                                Are you sure you want to change status of this book?
                            </p>
                        </div>
                    </div>
