        ...
        <div x-cloak x-show="isOpen" x-transition.scale @keyup.escape.window="isOpen = false"
            ...
            <div class="p-6 pb-4 bg-white sm:px-4 sm:pt-5 sm:pb-4">
                ...
                <div class="space-y-2 add-form">
                    ...
                    <input wire:model.defer="name" id="name" type="text" placeholder="Book Name"
                    ...
                    @enderror
                    <label for="cover" class="text-sm font-light text-gray-600">Book Cover: </label>
                    <div class="book-cover">
                        <input wire:model.debounce.500ms="cover_link" id="cover" type="text" placeholder="Cover link"
                            class="w-full px-3 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
                            id="cover_link">
                    ...
                    <input wire:model.defer="read_link" id="read_link" type="text" placeholder="Read link"
                        class="w-full px-3 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
                    @error("expire_time")
                    <div class="block p-2 my-1 text-white normal-case bg-red-500 rounded-lg">
                        {{$message}}
                    ...
                    @enderror
                    <label for="expire_time" class="text-sm font-light text-gray-600">Book Expire Time: </label>
                    <input wire:model.defer="expire_time" id="expire_time" type="date" placeholder="Expiration time"
                        class="w-full px-3 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
                </div>
            ...
            <div class="flex flex-row-reverse px-6 py-3 bg-gray-50 sm:px-4 sm:block">
                <button wire:click.prevent="save"
                    ...
                    <svg wire:loading wire:target="save" class="w-5 h-5 text-white animate-spin" fill="none"
                        viewBox="0 0 24 24">
