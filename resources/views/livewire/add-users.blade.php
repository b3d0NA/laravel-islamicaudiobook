<div wire:ignore.self @open-add-users-modal.window="isOpen = !isOpen" x-cloak x-data="{isOpen:false}" x-show="isOpen"
    ...
    window.Livewire.on('UserAddedSuccesfully', () => isOpen=false)
    ">
    <div class="items-end justify-center block min-h-screen p-0 text-center sm:pt-4 sm:px-4 sm:pb-20 sm:flex">
        ...
        <div x-cloak x-show="isOpen" x-transition.scale
            ...
            <div class="p-6 pb-4 bg-white sm:px-4 sm:pt-5 sm:pb-4">
                <h2 class="mb-4 text-xl font-semibold text-center">Add User</h2>
                ...
                <div class="space-y-2 add-form">
                    ...
                    @enderror
                    <input wire:model.defer="name" type="text" placeholder="User Name"
                    ...
                    @enderror
                    <input wire:model.defer="email" type="email" placeholder="User Email"
                        class="w-full px-3 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
                    @error("mobile")
                    <div class="block p-2 my-1 text-white normal-case bg-red-500 rounded-lg">
                        {{$message}}
                    ...
                    @enderror
                    <input wire:model.defer="mobile" type="number" placeholder="User Mobile Number"
                        class="w-full px-3 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
                    @error("fb_link")
                    <div class="block p-2 my-1 text-white normal-case bg-red-500 rounded-lg">
                        {{$message}}
                    ...
                    @enderror
                    <input wire:model.defer="fb_link" type="text" placeholder="User Facebook Link"
                        class="w-full px-3 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
                    @error("gender")
                    <div class="block p-2 my-1 text-white normal-case bg-red-500 rounded-lg">
                        {{$message}}
                    ...
                    <select wire:model.defer="gender"
                        ...
                        <option disabled>Select user gender</option>
                    ...
                    @enderror
                    <input wire:model.defer="password" type="password" placeholder="User Password"
                        class="w-full px-3 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
                </div>
            </div>
