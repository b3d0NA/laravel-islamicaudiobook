<div wire:ignore.self x-cloak x-data="{isOpen:false}" x-show="isOpen" x-transition.opacity
    ...
    window.Livewire.on('preparePaymentStatus', () => isOpen=true)
    window.Livewire.on('PaymentStatusChangedSuccessfully', () => isOpen=false)
    ">
        ...
        <div x-cloak x-show="isOpen" x-transition.scale @keyup.escape.window="isOpen = false"
            ...
            <div class="bg-white sm:px-4 sm:pt-5 sm:pb-4 p-6 pb-4">
                    ...
                    <div class="sm:mt-3 sm:text-center sm:ml-0 mt-0 ml-4 text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 normal-case">
                                Are you sure you want to change status of this payment?
                            </p>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 sm:px-4 py-3 px-6 sm:block flex flex-row-reverse">
                    <button wire:click.prevent="change"
                        class="sm:w-full flex items-center justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-teal-500 sm:text-base font-medium text-white hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-0 ml-3 w-auto text-sm">
                        <svg wire:loading wire:target="change" class="animate-spin h-5 w-5 text-white"
                        ...
                        <span wire:loading.remove wire:target="change">Change</span>
                    </button>
